...
import { svelteLang, svelteConf } from "./svelte";
import { solidityLang, solidityConf } from "./solidity";
import { haskellLang, haskellConf } from "./haskell";
import { zigLang, zigConf } from "./zig";
